...
using Tyuiu.DevjatkovaAA.Sprint2.Task1.V21.Lib;

namespace Tyuiu.DevjatkovaAA.Sprint2.Task1.V21
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* False, False, True, False), при a = 696, b = 987, c = 696, d = 155      *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
